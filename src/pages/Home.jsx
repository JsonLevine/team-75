...
export default function Home() {
  ...
  return (
    <div className="space-y-4 h-screen flex flex-col items-center justify-baseline bg-gray-900 text-white">
      ...
      <button
        className="bg-jl-red w-64 h-1/3 py-4 rounded-xl text-4xl font-semibold hover:bg-jl-red_hover cursor-pointer"
        onClick={() => handleSelect("jason")}
      >
        Jason
      </button>
      <button
        className="bg-gq-violet w-64 h-1/3 py-4 rounded-xl text-4xl font-semibold hover:bg-gq-violet_hover cursor-pointer"
